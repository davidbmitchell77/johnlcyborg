trigger OpportunityTrigger on Opportunity (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    TriggerSetting__mdt ts = TriggerSetting__mdt.getInstance(Test.isRunningTest() ? 'Test' : 'Opportunity');
    ...
    if (runTriggerHandler == true) {
        OpportunityTriggerHandler handler = new OpportunityTriggerHandler(Trigger.operationType);
