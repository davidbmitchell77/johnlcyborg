Trigger ContactTrigger on Contact (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    TriggerSetting__mdt ts = TriggerSetting__mdt.getInstance(Test.isRunningTest() ? 'Test' : 'Contact');
    ...
    if (runTriggerHandler == true) {
        ContactTriggerHandler handler = new ContactTriggerHandler(Trigger.operationType);
